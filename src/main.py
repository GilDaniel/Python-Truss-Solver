...
for element in elements:
    rigidity_constants.append(rc.rigidity_constant(element,nodes))

# Spread rigidity constants to global matrix
rig_matrix = rc.global_rigidity_matrix_spreading(rigidity_constants,nodes,elements)

# Get external force vector
ext_force_vector = tn.TrussNode.ext_force_vector(nodes)
...
# Solve linar system to find displacements
...
normal_forces = rc.find_normal_forces(rigidity_constants,elements,displacements)
